...
* Unicode - assigns a NUMBER to each character in written language
...
** Look at scripts.js
    ...
    * An object tells us the name of script, the Unicode ranges, the direction which it is written, origin time, whether it is still in use and a link for more info
        * ltr = left to right
        * rtl = right to left
        * ttb = top to bottom
    
        * 'ranges' property contains an array of Unicode character ranges, each of which is a 2 element array containing a lower and upper bound
            - lower bound is INCLUSIVE whereas the upper bound is EXCLUSIVE


*** Take a look at scripts.js
*/